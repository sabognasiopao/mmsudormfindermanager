...
<form>
    ...
    <div class="smallheader">OTHER INFORMATION</div>
        ...
        <button type="button" onclick="denyapplicant()" class="greenbutton" style="margin-top:0%;" >REMOVE</button>  
        <button type="button" onclick="acceptapplicant()" class="secondyellowbutton" style="margin-right:10px;margin-top:0%;">DOWNLOAD</button>
    </form>
</div>
