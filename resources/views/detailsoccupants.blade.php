...
<div class="listappcontainer">
    ...
    <form>
        <label for="fname">Full Name</label>
            <input type="text" id="fname" value="Paola Francisco" style="width:25%;" class="readapp" readonly="readonly">
        <label for="fstudentid">Student Number</label>
            <input type="text" id="fstudentid" value="18-020008" style="width:25%;" class="readapp" readonly="readonly"><br><br>
        <label for="gender">Sex</label>
            <input type="text" id="gender" value="Female" style="width:25%;" class="readapp" readonly="readonly">
        <label for="email">Email</label>
            <input type="email" id="email" value="pjnfrancisco@gmail.com" style="width:25%;" class="readapp" readonly="readonly"><br><br>
        <label for="number">Mobile Number</label>
            <input type="tel" id="number" value="09355350600" style="width:25%;" class="readapp" readonly="readonly">
        <label for="number">Contact of Guardian</label>
            <input type="tel" id="number" value="09355350600" style="width:25%;" class="readapp" readonly="readonly"><br><br>
        <label for="birthday">Date of Birth</label>
            <input type="text" id="birthday" value="11/04/2000" style="width:25%;" class="readapp" readonly="readonly">
        <label for="birthday">Address</label>
            <input type="text" id="birthday" value="Brgy. 26, Laoag City" style="width:25%;" class="readapp" readonly="readonly"><br><br><br><br>
        <label for="college">College:</label>
            <input type="text" id="college" value="CAS" style="width:25%;" class="readapp" readonly="readonly"><br><br>
        <label for="course">Course:</label>
            <input type="text" id="course" value="BSCS" style="width:25%;" class="readapp" readonly="readonly"><br><br>
        <label for="dormitory">Type of Room:</label>
            <input type="text" id="dormitory" value="Dormitory Type" style="width:25%;" class="readapp" readonly="readonly"><br><br><br>
